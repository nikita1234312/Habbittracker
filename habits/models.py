...
class HabitModel(models.Model):
    ...
    habit_type = models.CharField( max_length=10, choices=HABIT_TYPE_CHOICES, verbose_name='Тип привычки')
    ...
    reminder_time = models.TimeField(default=time(9, 0), verbose_name='Время выполнения')
    # Длительность выполнения привычки
    duration_minutes = models.PositiveIntegerField(default=15, validators=[MinValueValidator(1), MaxValueValidator(240)]) # до 4 часовverbose_name='Длительность (минуты)'
